...
MEMORY_REVIEW_PROMPT = (
    ...
    "Submit suggestions via memory_editor(target='memory', suggestions=[...]) only for: concise agent working-memory notes about the user's ongoing work, "
    ...
    "Submit suggestions via memory_editor(target='user', suggestions=[...]) for: user identity/role, "
    ...
    "- memory_editor records suggestions for later review; it does NOT directly overwrite the final stored text. The later memory-generation step is responsible for day-level grouping, deduplication, and conflict resolution.\n"
    ...
    "If there is a worthwhile memory or user_preference change, directly call memory_editor to submit the proposal. "
